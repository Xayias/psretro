...
const Hero = () => {
    return (
      <div className="relative w-full h-full overflow-hidden flex justify-center md:px-32 md:py-14 mt-20 md:mt-0">
        {/* Background Video */}
        ...
        {/* Content Overlay */}
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-center p-6 bg-opacity-50 text-white h-1/3 w-full xl:w-8/12">
          {/* Review Carousel */}
