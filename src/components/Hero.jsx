...
const Hero = () => {
    return (
      <div className="relative w-full h-full overflow-hidden flex justify-center md:px-14 md:py-14 mt-20 md:mt-0 xl:px-32">
        {/* Background Video */}
        ...
        {/* Content Overlay */}
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-center p-6 bg-opacity-50 text-white h-1/3 w-full 2xl:w-9/12 gap-5">
          {/* Review Carousel */}
          ...
          {/* News Section */}
          <div className="w-full md:w-1/3 py-10 h-full bg-black/50 rounded-lg">
